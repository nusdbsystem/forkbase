...
diff init.csv out-init-s.csv
diff init.csv out-init-c.csv
...
echo [Query CC : aa] expected result size is 1 ...
#$USTORE_LUCENE_CLI get-de-by-iq -t simple_key -b master -q "CC : aa"
$USTORE_LUCENE_CLI get-de-by-iq -t simple_key -b master -q "CC : aa" q4-s.csv
#$USTORE_LUCENE_CLI get-de-by-iq -t composed_key -b master -q "CC : aa"
$USTORE_LUCENE_CLI get-de-by-iq -t composed_key -b master -q "CC : aa" q4-c.csv
