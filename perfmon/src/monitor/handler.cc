 ...
 * =====================================================================================
 */
void pcapCallback(u_char * u_handler,
 ...
 * =====================================================================================
 */
void parseTcpPkt(PacketHandler * handler,
  const PacketHeader * header, const u_char * packet) {
 ...
 * =====================================================================================
 */
void parseIpPkt(PacketHandler * handler,
  const PacketHeader * header, const u_char * packet) {
 ...
 * =====================================================================================
 */
void parseEthernetPkt(PacketHandler * handler,
  const PacketHeader * header, const u_char * packet) {
 ...
 * =====================================================================================
 */
void parseSllPkt(PacketHandler * handler,
  PacketHeader * header, const u_char * packet) {
 ...
 * =====================================================================================
 */
void PacketHandler::startParseAndProcess(
  const struct pcap_pkthdr * header, const u_char * packet) {
 ...
 * =====================================================================================
 */
bool PacketHandler::processIpPkt(const PacketHeader * header,
  const u_char * packet) {
 ...
 * =====================================================================================
 */
bool PacketHandler::processTcpPkt(
  const PacketHeader * header, const u_char * packet) {
    struct tcphdr * tcp = (struct tcphdr *)packet;

    Packet *pkt = new Packet(userData_->src, ntohs(tcp->source),
      userData_->dst, ntohs(tcp->dest), header->len, header->ts);
...
int PacketHandler::dispatch(int count) {
    return pcap_dispatch(this->pcapHandler_,
      count, pcapCallback, (u_char *)this);
}
