...
TEST(SMap, Small) {
  ...
  ustore::SMap smap({k1, k2, k3}, {v1, v2, v3}, loader);
  ...
  ustore::SMap new_smap1(smap.Set(k4, v4), loader);
  ...
  // Set v3 with v4
  ustore::SMap new_smap2(new_smap1.Set(k3, v4), loader);
  ...
  ustore::SMap new_smap3(new_smap2.Remove(k1), loader);
  CheckIdenticalItems({k2, k3, k4}, {v2, v4, v4},
                      new_smap3.iterator().get());

  // Remove an non-existent key
  ustore::SMap new_smap4(smap.Remove(k4), loader);
...
TEST(SMap, Huge) {
  ...
  ustore::SMap smap(keys, vals, loader);
  ...
  // Remove
  ustore::SMap smap1(smap.Remove(keys[35]), loader);
  ...
  ustore::SMap smap2(smap.Set(keys[55], vals[56]), loader);
